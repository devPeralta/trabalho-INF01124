...
int main()
{
    ...
    printf("\n********************* PESQUISAS ********************\n");
    printf("Digite 1 para: Pesquisas sobre os nomes de jogadores\n");
    printf("Digite 2 para: Pesquisas sobre jogadores revisados por usuarios\n");
    printf("Digite 3 para: Pesquisas sobre os melhores jogadores de uma determinada posicao\n");
    printf("Digite 2 para: Pesquisas sobre tags de jogadores\n\n\n\n");
